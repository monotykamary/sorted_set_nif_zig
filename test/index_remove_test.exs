defmodule Discord.SortedSet.IndexRemove.Test do
  ...
  describe "remove from empty set" do
    test "any supported term returns the nil and the set" do
    ...
    test "any unsupported term returns an error" do
  ...
  describe "remove from a populated set" do
    test "remove an element that is not present does not change the set and returns nil" do
    ...
    test "remove an element that is present does change the set" do
    ...
    test "removing maintains ordering of remaining items" do
