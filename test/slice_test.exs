defmodule Discord.SortedSet.Slice.Test do
  ...
  describe "empty set" do
    test "slicing from any starting index at any length is the empty list" do
      check all(
  ...
  describe "populated set" do
    test "slicing starting past the size of the set of any size is the empty list" do
      check all(
              start <- positive_integer(),
              amount <- positive_integer()
            ) do
