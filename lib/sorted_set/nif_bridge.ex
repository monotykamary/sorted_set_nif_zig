defmodule Discord.SortedSet.NifBridge do
  ...
  def load_nif do
    _ = Application.ensure_loaded(:sorted_set_nif)

    case :code.priv_dir(:sorted_set_nif) do
      {:error, _} ->
        :ok
  ...
  @doc """
  Returns information about this NIF's memory allocations.
  """
  @spec jemalloc_allocation_info() :: any()
